      ...
      >
        ...
        >
          ...
          <motion.h1 variants={fadeUp} className="mb-4" style={{ lineHeight: 1.4 }}>
            ...
            <span className="block text-5xl sm:text-5xl md:text-6xl whitespace-nowrap" style={{ fontFamily: "var(--font-great-vibes), 'Great Vibes', cursive", color: '#1A1A1A', lineHeight: 1.4 }}>también se planifica</span>
          </motion.h1>
