        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          >
            ...
            <motion.div variants={fadeUp} className="flex flex-col gap-3 mb-10">
              <a href="https://wa.me/593962788765" target="_blank" rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-5 py-3 bg-[#25D366] text-white font-semibold rounded-full hover:bg-[#1ebe5a] transition-all duration-300 hover:shadow-lg text-sm w-fit">
              ...
              <p className="text-sm font-semibold text-radices-darker mt-1">Síguenos en</p>
              <a href="https://instagram.com/campusradices" target="_blank" rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-5 py-3 bg-gradient-to-br from-[#f09433] via-[#dc2743] to-[#bc1888] text-white font-semibold rounded-full hover:opacity-90 transition-all duration-300 hover:shadow-lg text-sm w-fit">
              ...
              <a href="https://www.facebook.com/share/18EEXn7JPf/" target="_blank" rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-5 py-3 bg-[#1877F2] text-white font-semibold rounded-full hover:bg-[#1464d8] transition-all duration-300 hover:shadow-lg text-sm w-fit">
              ...
              <a href="https://www.tiktok.com/@campus_radices?_r=1&_t=ZS-94zZKyaP36G" target="_blank" rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-5 py-3 bg-[#010101] text-white font-semibold rounded-full hover:bg-[#333] transition-all duration-300 hover:shadow-lg text-sm w-fit">
